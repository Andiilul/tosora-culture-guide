...
import { getAllEntertainment } from "../../../services/admin/entertainment";

interface EntertainmentsProps {}

export const Entertainments: React.FC<EntertainmentsProps> = () => {
	const [data, setData] = useState<EntertainmentTypes[] | undefined>(undefined);
	...
	return (
		<>
			<PageHeroes text="Hiburan" img="/assets/entertainments.jpeg" id="entertainments">
				Nikmati Keindahan Seni <br /> Dan Hiburan Desa Tosora
			</PageHeroes>
			<PageLayout>
				<Box
					width={"100%"}
									...
									>
										<Box display={"flex"} flexDirection={"column"} flex={1}>
											...
											<Typography
												...
												color={"primary"}
											>
												{map.type === "Arts" ? "Kesenian" : map.type === "Folk-Games" ? "Permainan Rakyat" : "Olahraga Tradisional"}
											</Typography>
											<WorksDesc
												fontSize={"14px"}
												fontFamily={"Poppins"}
